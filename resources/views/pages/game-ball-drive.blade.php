        ...
        <div class="container">
            <div class="section-detail">
                ...
                <div class="detail-description">
                    ...
                    <p class="detail-description-content">
                        Learn how to make a simple 3D game.
                    </p>
                    <br>
                    <div class="row mx-0 mb-5">
                        <a href="{{url('https://github.com/dimaswisodewo/Game_BallDrive')}}" class="btn btn-custom mr-4"><i class="fab fa-github mr-2"></i> Source Code</a>
                ...
                <div class="detail-description">
                    ...
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/3IzbfpZl54g" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
