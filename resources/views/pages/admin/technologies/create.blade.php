...
@section('title', 'Admin - New Technology')
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">New Item - Technology</h1>
        </div>
        ...
        <div class="card shadow">
            <div class="card-body">
                <form action="{{ route('technology.store')}}" method="POST"> {{--  action store untuk menyimpan data  --}}
                    @csrf
