...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('technology.create')}} " class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            ...
                            @forelse ($items as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('technology.destroy', $item->id) }} " method="POST" class="d-inline">
                                            @csrf
                                            @method('delete')
