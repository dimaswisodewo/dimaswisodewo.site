...
@section('title', 'Admin - New Work Platform')
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Item Platform - {{ $item->works->title }}</h1>
        </div>
        ...
        <div class="card shadow">
            <div class="card-body">
                <form action="{{ route('platform.update', $item->id) }}" method="POST"> {{--  action store untuk menyimpan data  --}}
                    @method('PUT')
                    @csrf
