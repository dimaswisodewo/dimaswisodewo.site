...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Platforms</h1>
            <a href="{{ route('platform.create')}} " class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                        ...
                        <tbody>
                            @forelse ($items as $item)
                                <tr>
                                    ...
                                    <td>{{$item->platform}}</td>
                                    <td>
                                        <a href="{{ route('platform.edit', $item->id) }}">
                                            <button class="btn btn-primary m-1">
                                                <i class="fa fa-pencil-alt"></i>
                                            </button>
                                        </a>
                                        <form action="{{ route('platform.destroy', $item->id) }} " method="POST" class="d-inline">
                                            @csrf
                                            @method('delete')
