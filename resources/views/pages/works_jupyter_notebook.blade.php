    ...
    <section class="section-works-header">
        <div class="container">
            <div class="d-flex">
                ...
                <a href="{{ route('works_jupyter_notebook') }}" class="works-menu active mr-3">Jupyter Notebook</a>
                    ...
                    <div class="col-sm-6 col-md-4 my-2 my-md-4">
                        <div class="card-works d-flex flex-column px-sm-0 px-md-4 text-center">
                                ...
                                <picture>
                                    ...
                                    @else
                                        <img src="{{ url('frontend/images/jupyter-notebook.png') }}" class="works-image img-thumbnail mt-3 mb-4" alt="">
                                    @endif
                                </picture>                                
